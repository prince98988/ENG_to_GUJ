...
public class per_pre extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.per_pre);
        View i =(View) findViewById(R.id.p1);
        mAudioManager=(AudioManager) getSystemService(Context.AUDIO_SERVICE);
        //i is button on the top of this activity layout for playing perfect present tense sound
        i.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    mMediaPlayer = MediaPlayer.create(per_pre.this,R.raw.per_p);
                    mMediaPlayer.start();
